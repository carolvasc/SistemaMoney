        ...
        <div class="col-md-6">
            <div id="conteudo">
                <form>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-class">
                                    ...
                                    <option>Receitas pessoais</option>
                                </select>
                            </div>
                        </div>
                    </div><!-- /row -->
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-success" name="repetir" id="btn-repetir">Repetir</button>
                        </div>
                    </div><!-- /row -->
                    <div class="row" id="box-repetir" hidden>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br/>
                                <input type="radio" name="receita" id="receita-parcelada" value="parcelada" onclick="getRadioValor();">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-success" name="salvar" id="btn-salvar">Salvar</button>
                        </div>
                    </div>
                </form>
            </div><!-- /conteudo -->
